...
public class DouYu63 {
    ...
    Logger logger = LoggerFactory.getLogger(DouYu63.class);


    //formData 表单数据
    private static final String FORMDATA = "nameEn=2020721codsj_credits1&giftId=927&csrfToken=d949943d8afa41709c8736293e8b73b2";
