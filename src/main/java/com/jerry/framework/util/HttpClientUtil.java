...
public class HttpClientUtil {
	...
	private void writeLog(String message, Throwable t) {
	 ...
	 * @return String
	 */
	public String sendData(String url,Map<String,String> dataMap,int timeout){
		HttpClient httpClient = new HttpClient(); 
		HttpConnectionManagerParams configParams = httpClient.getHttpConnectionManager().getParams();  
        configParams.setConnectionTimeout(timeout * 1000);
        configParams.setSoTimeout(timeout * 1000);
        httpClient.getParams().setConnectionManagerTimeout(timeout * 1000l);
		String text = "";
...
//          text = new String(postMethod.getResponseBody(),this.getEncode());
//			text = URLDecoder.decode(text, t);
