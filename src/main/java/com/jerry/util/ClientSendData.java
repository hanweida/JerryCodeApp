...
public class ClientSendData {
    ...
    public ClientSendData() {
        Url = "https://kyfw.12306.cn/otn/leftTicket/queryZ?leftTicketDTO.train_date=2019-01-02&leftTicketDTO.from_station=BJP&leftTicketDTO.to_station=HBB&purpose_codes=ADULT";
    }
    ...
    public String sendData(String data) {
        ...
        try {
            ...
            receivedData = sendGet(Url, paramsData);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return receivedData;
