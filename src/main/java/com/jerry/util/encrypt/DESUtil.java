 ...
 * @author roger
 * @date Jun 14, 2012 6:10:25 PM
 */
public class DESUtil {
	
	private static String strDefaultKey = "easou.com";
	 ...
	 * */
	 ...
	 /**   * 加密字节数组   *   * @param arrB   *            
	  * 需加密的字节数组   * @return 加密后的字节数组   * @throws Exception   */
	 ...
	 public static void main(String[] args) {
		 try {  
				 ...
				 System.out.println("加密后的字符："+encrypt+"    长度"+encrypt.length());
