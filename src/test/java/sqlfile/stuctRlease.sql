...
) ENGINE=InnoDB AUTO_INCREMENT=9304865 DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_ad_ext` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ad_id` (`ad_id`)
) ENGINE=InnoDB AUTO_INCREMENT=51106 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10265547 DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_biz_customer_bill` (
  ...
  `discount` int(3) DEFAULT '100' COMMENT '出价*该字段折扣 计算为实际出价 按实际出价影响广告排名 ',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13749 DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_dsp_history_data` (
  ...
  `dsp_pt` varchar(300) DEFAULT NULL,
  `adtype` double DEFAULT NULL,
  `os` double DEFAULT NULL,
  `show_data` double DEFAULT NULL,
  `click_data` double DEFAULT NULL,
  `down_data` double DEFAULT NULL,
  `downed_data` double DEFAULT NULL,
  `installed_data` double DEFAULT NULL,
  `date_data` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_es_media` (
  ...
  `function_type` tinyint(4) DEFAULT NULL COMMENT '功能类别：1：对应宜搜品牌广告功能 2：对应宜搜开屏广告功能',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_es_openscreen_ad` (
  ...
  `imagepath_2` varchar(1024) DEFAULT NULL COMMENT '用户上传图片到服务器的路径地址',
  `click_type_2` int(4) DEFAULT '1' COMMENT '点击类型：仅展示(0)，打开网页(1)，直接下载(2)',
  `url_2` varchar(1024) DEFAULT NULL,
  `packagename_2` varchar(255) DEFAULT NULL COMMENT '下载类包名',
  `downappflag_2` tinyint(4) DEFAULT '0' COMMENT '直接下载选项判断 0：输入url 1：上传包',
  `imagepath_3` varchar(1024) DEFAULT NULL COMMENT '用户上传图片到服务器的路径地址',
  `click_type_3` int(4) DEFAULT '1' COMMENT '点击类型：仅展示(0)，打开网页(1)，直接下载(2)',
  `url_3` varchar(1024) DEFAULT NULL,
  `packagename_3` varchar(255) DEFAULT NULL COMMENT '下载类包名',
  `downappflag_3` tinyint(4) DEFAULT '0' COMMENT '直接下载选项判断 0：输入url 1：上传包',
  `imagepath_4` varchar(1024) DEFAULT NULL COMMENT '用户上传图片到服务器的路径地址',
  `click_type_4` int(4) DEFAULT '1' COMMENT '点击类型：仅展示(0)，打开网页(1)，直接下载(2)',
  `url_4` varchar(1024) DEFAULT NULL,
  `packagename_4` varchar(255) DEFAULT NULL COMMENT '下载类包名',
  `downappflag_4` tinyint(4) DEFAULT '0' COMMENT '直接下载选项判断 0：输入url 1：上传包',
  `imagepath_5` varchar(1024) DEFAULT NULL COMMENT '用户上传图片到服务器的路径地址',
  `click_type_5` int(4) DEFAULT '1' COMMENT '点击类型：仅展示(0)，打开网页(1)，直接下载(2)',
  `url_5` varchar(1024) DEFAULT NULL,
  `packagename_5` varchar(255) DEFAULT NULL COMMENT '下载类包名',
  `downappflag_5` tinyint(4) DEFAULT '0' COMMENT '直接下载选项判断 0：输入url 1：上传包',
...
CREATE TABLE `t_es_proto_ad` (
  ...
  `click_monit_url` varchar(1024) DEFAULT NULL COMMENT '点击监控URL',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=588 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=1366325 DEFAULT CHARSET=utf8
...
) ENGINE=InnoDB AUTO_INCREMENT=2511603 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=165453 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10702830 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=204611593 DEFAULT CHARSET=utf8
...
CREATE TABLE `t_sys_verify_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24018 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3693149 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=25272905 DEFAULT CHARSET=utf8;
